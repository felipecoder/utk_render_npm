...
export class GameRender {
    constructor() {
        ...
        cameraRTT.setViewOffset(window.innerWidth, window.innerHeight, 0, 0, window.innerWidth/2, window.innerHeight);
...
`
    ...
    resize(screenshot) {
        ...
        if (screenshot === true) {
            ...
            cameraRTT.setViewOffset(window.innerWidth, window.innerHeight, 1, 0, width, window.innerHeight);
        }
